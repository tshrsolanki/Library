...
const bookname = { height: "5vh", fontSize: "3vh", width: "70%" };
const author = { height: "5vh", fontSize: "3vh", width: "60%" };
const genre = { height: "5vh", fontSize: "3vh", width: "50%" };
const qty = { height: "5vh", fontSize: "3vh", width: "40%" };
const tqty = { height: "5vh", fontSize: "3vh", width: "6%" };
const tgenre = { height: "5vh", fontSize: "3vh", width: "10%" };
const tauthor = { height: "5vh", fontSize: "3vh", width: "20%" };
const tid = { height: "5vh", fontSize: "3vh", width: "5%" };
const tbookname = { height: "5vh", fontSize: "3vh", width: "40%" };
...
export const EditBookList = (props) => {
  ...
  const Delete = (id) => {
    if (window.confirm("Are you sure to delete the book")) {
      fetch(`http://localhost:4000/admin/deletebook/${id}`)
        .then((data) => {
          return data.json();
        })
        .then((data) => {
  ...
  useEffect(() => {
    fetch("http://localhost:4000/book/list")
      .then((data) => {
        return data.json();
      })
      .then((data) => {
